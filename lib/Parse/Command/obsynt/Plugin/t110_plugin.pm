package Parse::Command::obsynt::Plugin::t110_plugin;

=head1 NAME
Parse::Command::obsynt::Plugin::t110_plugin
=cut
...
sub add_remaps {
	my ($self,$opt,$header) = @_;
	push @{$opt->{remap}}, $_ for ('T110_TRX_H,BSS_release,VERSION','T110_SECTOR_H,BSS_release,VERSION','T110_TRX_H,BTS_INDEX,BTS_ID','T110_TRX_H,BTS_SECTOR,SECTOR','T110_TRX_H,CELL_CI,CI','T110_TRX_H,CELL_LAC,LAC','T110_TRX_H,TRXID,TRX','T110_SECTOR_H,BTS_INDEX,BTS_ID','T110_SECTOR_H,BTS_SECTOR,SECTOR','T110_SECTOR_H,CELL_CI,CI','T110_SECTOR_H,CELL_LAC,LAC'); 
}
